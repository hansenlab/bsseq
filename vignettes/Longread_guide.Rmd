...
```{r}
# Define path in package extdata
#HDF5Array::saveHDF5SummarizedExperiment(mc_filtered, "~/Documents/bsseq/inst/extdata/longread/silversides/mc_filtered.hdf5")

# Load pre-saved HDF5 file
#mc_filtered <- HDF5Array::loadHDF5SummarizedExperiment(hdf5_path)
#mc_filtered
